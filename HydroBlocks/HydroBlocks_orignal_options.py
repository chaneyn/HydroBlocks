...
class HydroBlocks:
 ...
 def initialize_noahmp(self,):
  ...
  #Define the options
  self.noahmp.idveg = 3#3 # dynamic vegetation (1 -> off ; 2 -> on)
  ...
  self.noahmp.iopt_rad = 2#2 # radiation transfer (1->gap=F(3D,cosz); 2->gap=0; 3->gap=1-Fveg)
  ...
  self.noahmp.z_ml[:] = np.sum(self.noahmp.sldpth) # Noemi
  ...
  self.noahmp.clay_pct  = self.input_fp.groups['parameters'].variables['clay'][:] 
 ...
 def update_output(self,date):
  ...
  tmp['runoff'] = NOAH.dt*(np.copy(NOAH.runsf)+np.copy(NOAH.runsb)) #mm # Noemi
 ...
 def create_netcdf_file(self,):
  ...
  metadata = {
             ...
             #'lwnet':{'description':'Net longwave radiation','units':'W/m2','dims':('time','hru',)},
             #'swnet':{'description':'Absorbed shortwave radiation','units':'W/m2','dims':('time','hru',)},
             'trad':{'description':'Land surface skin temperature','units':'K','dims':('time','hru',)},
             'stc':{'description': 'Snow soil temperature','units':'K','dims':('time','hru',)},
             'salb':{'description':'Land surface albedo','units':' ','dims':('time','hru',)},

             'qbase':{'description':'Excess runoff','units':'mm/s','dims':('time','hru',)},
             'qsurface':{'description':'Surface runoff','units':'mm/s','dims':('time','hru',)},
             'runoff':{'description':'Total runoff','units':'mm/s','dims':('time','hru',)},
             ...
             'totsmc':{'description':'totsmc','units':'m3/m3','dims':('time','hru',)},
             'hdiv':{'description':'hdiv','units':'mm/s','dims':('time','hru','soil')},

             'smc1':{'description':'Soil water content at the root zone','units':'m3/m3','dims':('time','hru',)},
             'smc_root':{'description':'Soil water content at the root zone','units':'m3/m3','dims':('time','hru',)},  
             'demand_agric':{'description':'Irrigation demand','units':'m','dims':('time','hru',)},
             'deficit_agric':{'description':'Irrigation deficit','units':'m','dims':('time','hru',)},
             'demand_indust':{'description':'Industrial demand','units':'m','dims':('time','hru',)},
             'deficit_indust':{'description':'Industrial deficit','units':'m','dims':('time','hru',)},
             'demand_domest':{'description':'Domestic demand','units':'m','dims':('time','hru',)},
             'deficit_domest':{'description':'Domestic deficit','units':'m','dims':('time','hru',)},
             'demand_lstock':{'description':'Livestock demand','units':'m','dims':('time','hru',)},
             'deficit_lstock':{'description':'Livestock deficit','units':'m','dims':('time','hru',)},
             'irrig_agric':{'description':'Irrigated volume','units':'m','dims':('time','hru',)},
             }
