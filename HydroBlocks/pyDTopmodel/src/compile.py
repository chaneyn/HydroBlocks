...
cmd = 'gfortran -c dynamic_topmodel_tools.f90 -lgomp -liomp5 -lmkl_rt -lpthread -lm -w -O3 -funroll-loops -m64 -Wl,--no-as-needed -openmp -fopenmp -g -fbacktrace -fpic -o dynamic_topmodel_tools.o -I%s -L%s -L/lib64/ -L/usr/lib64' % (mkl_include,mkl_library)
#print cmd
os.system(cmd)
...
cmd = 'f2py -c dynamic_topmodel_tools.pyf dynamic_topmodel_tools_wrapper.f90 *.o -lgomp -lmkl_rt -L%s --fcompiler=gnu95 -L/lib64/ -L/usr/lib64' % (mkl_library)
#print cmd
os.system(cmd)
