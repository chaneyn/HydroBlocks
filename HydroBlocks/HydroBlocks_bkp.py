...
class HydroBlocks:
 ...
 def initialize_noahmp(self,):
  ...
  self.noahmp.iopt_inf = 2#2 # frozen soil permeability (1-> NY06; 2->Koren99) # Noemi, inf=1 led to num. instability
  ...
  self.noahmp.iopt_stc = 2#1 # snow/soil temperature time scheme (only layer 1) 1 -> semi-implicit; 2 -> full implicit (original Noah)
