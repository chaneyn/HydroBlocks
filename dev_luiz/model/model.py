...
def determine_cid_rank_mapping(MPdb):
  ...
  HBdb = MPdb.HBdb
  rank = MPdb.mpi_rank
  #print('cids',cids,len(cids),'rank luiz0',rank,flush=True)
  ...
  #print('cids',cids,len(cids),'rank luiz1',rank,flush=True)
  ...
  if rank != 0:
   ...
   #print('cids',cids,len(cids),'rank luizc',rank,flush=True)
  elif rank == 0:
   db = {}
   for cid in cids:
    #print('cids',cids,len(cids),'rank luiza',rank,flush=True)
    self = HBdb[cid]
    db[self.cid] = 0
  ...
  #print('cids',cids,len(cids),'rank luiz2',rank,flush=True)
  ...
  #print('cids',cids,len(cids),'rank luiz3',rank,flush=True)
  ...
  #print('cids',cids,len(cids),'rank luiz4',rank,flush=True)
